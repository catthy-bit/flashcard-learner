...
## Comments
### SPA
This application contains one main page to handle all the core ofeatures. This is done with useState to give the illusion that multiple pages have been used.

### CRUD Operations
On a database level, this application performs all CRUD operations and is utilised with the help of mySQL to connect to the front end files.
